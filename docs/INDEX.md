...
| [RETELL_SANDBOX_VALIDATION_PLAN.md](RETELL_SANDBOX_VALIDATION_PLAN.md) | 📐 | The **not yet executed** procedure for first real Retell validation: web call before phone number, prerequisites, sequence, billable actions, cleanup | Future sandbox procedure, provider cost expectations |
